...
<section>
        <div class="d-md-flex p-2 flex-column justify-content-start align-items-start">
            <form id="createForm" method="post" action="/eventType/3rd" enctype="multipart/form-data">
                @csrf

                <div class="p-2">
                    <h3 class="fw-bold">Enter Tournament Details</h3>
                </div>
                ...
                <div class="container">
                    <div class="d-flex p-2 justify-content-end mx-4">
                        <!-- <button class="btn grey-bg-color mx-2 text-white" >Return</button> -->
