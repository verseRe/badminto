...
<body>
    ...
    <div class="container">
        ...
        <h4 class=" text-center" class="text-black"><strong>{{ request()->get('image_url') }}</strong></h4>
        <h4 class=" text-center" class="text-black"><strong>{{ request()->get('match_name') }}</strong></h4>
